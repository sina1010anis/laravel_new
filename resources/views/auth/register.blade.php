...
<div class="body">
    <div class="veen">
        <div class="login-btn splits">
            <button class="active">تبت نام</button>
        </div>
        <div class="rgstr-btn splits">
            <p>ایا ثبت نام کرده اید ؟</p>
            <a style="color: white;padding: 5px 20px ; border: 1px solid white;border-radius: 100px" href="{{route('login')}}">ورود</a>
        </div>
        <div class="wrapper">
            <form method="post" action="{{route('register')}}" id="login" tabindex="500">
                @csrf
                <h3>ثبت نام</h3>
                <div class="name">
                ...
                <div class="mail">
                    <input value="{{old('email')}}" type="mail" name="email">
                    @error('email')
                        <p style="font-family: IRANSansWeb;color: red">{{$message}}</p>
                    @enderror
                    <label>ایمیل</label>
